...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-06-23 07:47`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/044647ad-ac58-42d0-b5e5-eefdf1752b6c.git
$ cd 044647ad-ac58-42d0-b5e5-eefdf1752b6c
```
